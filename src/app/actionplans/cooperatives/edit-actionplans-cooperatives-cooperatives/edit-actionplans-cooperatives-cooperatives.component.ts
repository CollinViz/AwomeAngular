...
@Component({
  selector: 'app-edit-actionplans-cooperatives-cooperatives',
  templateUrl: './edit-actionplans-cooperatives-cooperatives.component.html',
  styles: []
})
export class EditActionplansCooperativesCooperativesComponent implements OnInit {

  ActivityTable:string = "cooperative_actionplans_activity";
  ActionPlanTable:string = "cooperative_actionplans";
  ActionPlanID:string ="Cooperative_ActionPlan_ID";
  ActivityID:string = "Cooperative_Activity_ID";
  BaseTableID="Cooperative_ID";
  BaseTable="cooperative";
